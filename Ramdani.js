...
module.exports = Ramdani = async (Ramdani, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = Ramdani.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© CREATOR By Deffri Gans ","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/Ramdani3.jpg`)},"title": `© CREATOR By Deffri Gans `,"description": "Ramdani Official", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Ramdani Official","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
➸ *Sejak* : ${getTime}`
	...
	const sendButloc = async(id, text1, desc1, gam1, but = [], options = {}) => {
               let kma = gam1
               Ramdini.sendMessage(id, {"contentText": text1,
               "footerText": desc1, 
               "buttons": but,
               "headerType": "LOCATION",
                       "locationMessage": {
...
async function sendButLocation(id, text1, desc1, gam1, but = [], options = {}) {
            ...
            return Ramdini.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
        }       
...
└────────────>
    ├❒ *INFO BOT*
    ├• *Nama bot : ${api}*
    ├• *Nomor : wa.me/6282132805286
    ├• *Owner : Deffri Gans*
    ├• *Aktif : ${runtime(process.uptime())}*
    ├• *Prefix : 『> multi prefix <』*
    ├• *Baterai : ${baterai}%*
    ├• *Pukul : ${moment().utcOffset('+0700').format('HH:mm')}*
    ├• *Tanggal : ${moment.tz('Asia/Jakarta').format('DD/MM')} 2022*
    └────────────>
`
...
━━━━━ *INFO BOT* ━━━━━
❏ NAMA : *DEFFBOTz*
❏ API : *@6282132805286-@6288296339947*
❏ OWNER : *Deffri Gans*
❏ API : *@6282132805286*
❏ AKTIF : *${runtime(process.uptime())}*
❏ BATERAI : *${baterai}%*
...
🎉🎊🥳🎊🎉🥳🎊🎉🥳🎊🎉🥳`
               ...
               buttonsMessage = {
               contentText: `${man}`,
               footerText: '© Creator by Deffri Gans', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
//------------------< Premium >-------------------
       ...
       case 'sewabot':
              ...
              teksnya = `*[ PRICE LIST ]*
*Sewa Bot © CREATOR By Deffri Gans *
*1 Hari :* 2K
*1 Minggu :* 10K
*1 Bulan :* 20K
...
│➸ヅ ${prefix}gura*
│➸ヅ ${prefix}stickeranime*
│➸ヅ ${prefix}semoji* _emoji_
│➸ヅ ${prefix}sticker* _reply foto/video_
│➸ヅ ${prefix}smeme* _teks|teks_
│➸ヅ ${prefix}swm* _pack|author_
│➸ヅ ${prefix}take* _pack|author_`
              Ramdani.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
 case 'buttondl':
              gopeynya = 'https://i.ibb.co/kynNYTh/Ramdani2.jpg'
...
• ${prefix}limitgame*
│➸ヅ ${prefix}slot*
│➸ヅ ${prefix}gelud* _@tag_
│➸ヅ ${prefix}tictactoe* _@tag_
│➸ヅ ${prefix}siapaaku*
│➸ヅ ${prefix}family100*
│➸ヅ ${prefix}kuismath*
│➸ヅ ${prefix}asahotak*
...
│➸ヅ ${prefix}tebakumur*
│➸ヅ ${prefix}tebakbendera*
│➸ヅ ${prefix}suit* _batu/kertas/gunting_`
              Ramdani.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
case 'buttongc':
              gopeynya = 'https://i.ibb.co/kynNYTh/Ramdani2.jpg'
...
│➸ヅ ${prefix}groupsetting*
│➸ヅ ${prefix}getbio* _reply_
│➸ヅ ${prefix}afk* _alasan_
│➸ヅ ${prefix}kontak* _nomor|nama_
│➸ヅ ${prefix}ceksewa*
│➸ヅ ${prefix}kickall*
│➸ヅ ${prefix}infogrup*
│➸ヅ ${prefix}promote*
...
│➸ヅ ${prefix}demoteall*
│➸ヅ ${prefix}listonline*
│➸ヅ ${prefix}tagall* _teks_
│➸ヅ ${prefix}leave*
│➸ヅ ${prefix}kick* _reply_
│➸ヅ ${prefix}add* _628xxx_
│➸ヅ ${prefix}setnamegc*
│➸ヅ ${prefix}setppgc*
│➸ヅ ${prefix}getpp*
│➸ヅ ${prefix}setdeskgc*
│➸ヅ ${prefix}sider* _reply chat bot_
│➸ヅ ${prefix}hidetag* _teks/reply teks_
│➸ヅ ${prefix}linkgc*
│➸ヅ ${prefix}getdeskgc*`
              Ramdani.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
...
│➸ヅ ${prefix}otakuongoing*
│➸ヅ ${prefix}nhentai *code*
│➸ヅ ${prefix}nekopoi _link_*
│➸ヅ ${prefix}nekopoi3d*
│➸ヅ ${prefix}nekopoicosplay*
...
│➸ヅ ${prefix}bc* _teks_
│➸ヅ ${prefix}tobc* _audio_
│➸ヅ ${prefix}term*
│➸ヅ ${prefix}eval*
│➸ヅ ${prefix}clearall*
│➸ヅ ${prefix}leaveall*
│➸ヅ ${prefix}join* _teks_
│➸ヅ ${prefix}shutdown*
│➸ヅ ${prefix}getquoted*
│➸ヅ ${prefix}addupdate* _fiturnya_
│➸ヅ ${prefix}exif* _nama|author_
│➸ヅ ${prefix}sewa add/del* _waktunya_
│➸ヅ ${prefix}premium add* _@tag|nomor_
│➸ヅ ${prefix}premium del* _@tag|nomor_
│➸ヅ ${prefix}setpp*
│➸ヅ ${prefix}setbio*
│➸ヅ ${prefix}setname*
│➸ヅ ${prefix}getpp*
│➸ヅ ${prefix}sharelock*
│➸ヅ ${prefix}chat* _nomor|teks_`
              Ramdani.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftext, caption: teksnya })
              break
...
Ramdani.sendMessage(from, mp3, audio, {quoted: mek})
break
case 'ytmp4':
if (args.length ==0)return reply('Link nya Mana banh?')
reply(mess.wait)
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              Ramdani.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *© CREATOR By Deffri Gans * DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
"caption": "https://chat.whatsapp.com/KPnLOIu5BwD24kvoXbNHRp",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
Ramdani.sendMessage(from, bf, image, { quoted: freply, caption: 'Nah Kak Jangan Lupa Support DEFFBOTz yah Kak😁' })
break
case 'pipe':
if (args.length < 1) return reply(`Nama yang mau di tulis?\nContoh: ${prefix + command} DEFFBOTz`)
reply(mess.wait)
...
//------------------< Lainnya >-------------------
        ...
        case 'infobot':  // Jangan Di Ubah Plise
               gopeynya = 'https://i.ibb.co/kynNYTh/Ramdani2.jpg'
               thankslort = `━━━━━ *INFO BOT* ━━━━━\n➤ *BOT INI SUDAH DI RECODE OLEH DEFFBOTz\n➤ *RUN BOT : TERMUX*\n➤ *TIPE : NODE JS*\n➤ *BASE : RAMDANI OFFICIAL*\n*━━━━━━━━━━━━━━━━━━━━*`
...
//------------------< Menunya Bang:v >-------------------
     case 'info bot':
     reply (`━━━━━ *INFO BOT* ━━━━━
❏ BOT INI MENGGUNAKAN SCRIPT BOT DARI
❏ YT RAMDANI OFFICIAL 
❏ RUN BOT : SUPPORT HEROKU
❏ MODEL SC : JSON KEY
❏ BASE : RAMDANI OFFICIAL
*━━━━━━━━━━━━━━━━━━━━*`)
     case 'allmenu':
      ...
      case 'qris':      
        qris =`*SCAN QRIS NYA OM, TEEF SEIHKLASNYA🗿*`
              ...
              Ramdani.relayWAMessage(prep)
                ...
                break
      case 'dana':
             reply(`DANA : 082132805286`)
             break
           case 'gopay':
             reply(`*Goopay :* 082132805286`)
             break  
         case 'pulsa':
             reply(`*Pulsa :* 082132805286`)
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://www.instagram.com/b4c00t.dtz`)
             break
      case 'grupbot':
             reply('ga ada Anjg')
             break
...
reply('_' + err + '_\n\n' + js)
		...
		if (budy.includes(`Bot`)) {
                  ...
                  reply(`Iya gw Bot, Apa? Gak seneng lu?`)
